{smcl}
{hline}
{cmd:help: {helpb lmnjbxt}}{space 50} {cmd:dialog:} {bf:{dialog lmnjbxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmnjbxt: Panel Data Non Normality Jarque-Bera Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmnjbxt##01:Syntax}{p_end}
{p 5}{helpb lmnjbxt##02:Options}{p_end}
{p 5}{helpb lmnjbxt##03:Description}{p_end}
{p 5}{helpb lmnjbxt##04:Saved Results}{p_end}
{p 5}{helpb lmnjbxt##05:References}{p_end}

{p 1}*** {helpb lmnjbxt##06:Examples}{p_end}

{p 5}{helpb lmnjbxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmnjbxt} {depvar} {indepvars} {ifin} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt cross} {opt coll} {err:]}{p_end}
...
{p 2 2 2} {cmd:lmnjbxt} computes Panel Data Non Normality Jarque-Bera Test.
...
{p 2 4 2 }{cmd:lmnjbxt} saves the following results in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmnjbxt.dta, clear}

  {stata db lmnjbxt}

  {stata lmnjbxt y x1 x2 , id(id) it(t)}
{hline}

. clear all
. sysuse lmnjbxt.dta, clear
. lmnjbxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Data Non Normality Jarque-Bera Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
- Jarque-Bera LM Test                  =   1.8358     P-Value > Chi2(2) 0.3994
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNJBXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2016)}{p_end}
{p 1 10 1}{cmd:LMNJBXT: "Stata Module to Compute Panel Data Non Normality Jarque-Bera Test"}{p_end}
