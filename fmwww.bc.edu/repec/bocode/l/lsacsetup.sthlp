...
{p 0 4}{cmdab:rel:ease}({it:integer}) specifies the release of the LSAC data to be used (e.g., 8).
...
{p 2 2}{inp:. lsacsetup, data("D:\Data\LSAC") saving("D:\Mydata\LSAC") filename(LSAC) release(8) var(zhb05c zbf6mth bwpct prel asdqta asdqtb asdqtb csdqtb) hhfile(aweights cdwt) naplanfile(stream y3write) nomid}
