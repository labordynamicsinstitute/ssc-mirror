...
{pstd}
Same as above but specifying rforest as the estimation model (note that "race" is not specified with the "i." prefix as above) {p_end}
{phang2}{bf:{stata "looclass low age lwt race smoke ptl ht ui, model(rforest) fig":. looclass low age lwt race smoke ptl ht ui, model(rforest) fig}}{p_end}
