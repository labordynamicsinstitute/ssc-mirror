...
/*
 luvain_gcd generates a toy example of a weighted graph. It takes an integer as 
 ...
 subsequently apply the luvain clustering module you can gain insight and intuition 
 into the luvain clustering method.
