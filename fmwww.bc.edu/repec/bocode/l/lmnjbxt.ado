...
tempvar D DE DF1 E dcs TimeN EE idv itv LE P Q Sig2 SSE YYv Yh_ML Ue_ML Z
tempvar SST Time wald weit Wi Wio WS X X0 Bo Xb XB Xo XQ Yb Yh Yh2 Yhb Yho Yt YY YYm
tempvar E2 E3 E4 LDE LE P Q Sig2 SSE uiv Xb XB Yb Yh Yh2 Yhb Yho Yt YY Z
tempname A B b Beta Bx Cov D den DF Dim Dx E E1
...
tempname V V1 V1s Wi1 Wio WS WW WY X X0 XB Y Yh Yh_ML YYm YYv Z
qui xtset `id' `it'
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** Panel Data Non Normality Jarque-Bera Test}}"
di _dup(78) "{bf:{err:=}}"
