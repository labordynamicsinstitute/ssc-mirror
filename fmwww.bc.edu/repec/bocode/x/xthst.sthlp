...
{p 8}{stata xthst d.log_rgdpo log_hc log_ck log_ngd}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd, partial(log_hc log_ck log_ngd)}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd, hac}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd, hac kernel(qs)}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd, comparehac}.{p_end}
...
{p 8}{stata xthst d.log_rgdpo L.d.log_rgdpo log_hc log_ck log_ngd, cr(d.log_rgdpo log_hc log_ck log_ngd, cr_lags(1 3 2 3))}.{p_end}

{p 4 4}As a final example, the AR(p) adjusted test from Pesaran, Yamagata (2008)
can be employed using the option {cmd:ar}:{p_end}

{p 8}{stata xthst d.log_rgdpo L(1/3).d.log_rgdpo, ar}.{p_end}
...
{p 4}Please cite as:{break}
Bersvendsen, Ditzen. 2021. Testing for slope heterogeneity in Stata. The Stata Journal 21(1), pp. 1-30.{p_end}
...
{p_end}
{p 4 8}This version: 1.3 - 13 February 2020{p_end}
