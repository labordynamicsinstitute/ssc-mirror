{smcl}
{hline}
{hi:help xtbreak test}{right: v. 2.2 - 03. December 2025}
{right:SJ25-3: st0781}
{hline}
{title:Title}
...
{cmd:{help xtbreak_test##options1:options1}}
{cmd:{help xtbreak_test##options5:options5}}{p_end}
...
{cmd:breaks(}{it:#}{cmd:)} 
{cmd:{help xtbreak_test##options1:options1}}
{cmd:{help xtbreak_test##options2:options2}}
{cmd:{help xtbreak_test##options3:options3}}
{cmd:{help xtbreak_test##options4:options4}}
{cmd:{help xtbreak_test##options5:options5}}
{p_end}
...
{p 4}{help xtbreak_test##description:Description}{p_end}
{p 4}{help xtbreak_test##options:Options}{p_end}
{p 4}{help xtbreak_test##note_panel:Notes on Panel Data}{p_end}
{p 4}{help xtbreak##cov:Covariance Estimator}{p_end}
{p 4}{help xtbreak_test##saved_vales:Saved Values}{p_end}
{p 4}{help xtbreak_test##examples:Examples}{p_end}
{p 4}{help xtbreak_test##references:References}{p_end}
{p 4}{help xtbreak_test##about:About, Authors and Version History}{p_end}
...
Karavias, Narayan, Westerlund ({help xtbreak_test##KNW2021:2021})
...
For the time series case see Bai & Perron ({help xtbreak_test##BP1998:1998}, {help xtbreak_test##BP2003:2003}),
for the panel data case see 
Karavias, Narayan, Westerlund ({help xtbreak_test##KNW2021:2021})
and Ditzen, Karavias, Westerlund ({help xtbreak_test##DKW2021:2025}) {p_end}
...
{p 4 4}Bai & Perron ({help xtbreak_test##BP1998:1998}) suggest to take the supremum of the 
F-Statistics:{p_end}
...
Critical values can be found in Bai & Perron ({help xtbreak_test##BP1998:1998}, {help xtbreak_test##BP2003:2003}) 
...
{p 4 4}where  supF(s,q) is as defined {help xtbreak_test##h1def:above}.{p_end}
