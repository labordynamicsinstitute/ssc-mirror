...
xtdcce2 d.log_rgdpo log_hc log_ck log_ngd , reportc
...
xtdcce2 d.log_rgdpo L.log_rgdpo log_hc log_ck log_ngd , reportc cr(d.log_rgdpo L.log_rgdpo log_hc log_ck log_ngd) cr_lags(3)
xtdcce2 d.log_rgdpo L.log_rgdpo log_hc log_ck log_ngd , reportc cr(d.log_rgdpo L.log_rgdpo log_hc log_ck log_ngd) cr_lags(3)
xtdcce2 d.log_rgdpo d.L.log_rgdpo d.log_hc d.log_ck d.log_ngd , reportc lr(L.log_rgdpo log_hc log_ck log_ngd) p(L.log_rgdpo log_hc log_ck log_ngd)
xtdcce2 d.log_rgdpo d.L.log_rgdpo d.log_hc d.log_ck d.log_ngd , reportc lr(L.log_rgdpo log_hc log_ck log_ngd) p(L.log_rgdpo log_hc log_ck log_ngd) lr_options(nodivide)
xtdcce2 d.log_rgdpo d.L.log_rgdpo d.log_hc d.log_ck d.log_ngd , reportc lr(L.log_rgdpo log_hc log_ck log_ngd) p(L.log_rgdpo log_hc log_ck log_ngd) lr_options(xtpmgnames)
