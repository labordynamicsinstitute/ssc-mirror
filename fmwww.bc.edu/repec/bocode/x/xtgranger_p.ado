*! predict program for xtgranger
*! 04.07.2022 by Jan Ditzen

cap program drop xtgranger_p
program define xtgranger_p
...
capture mata mata drop m_xtgranger_p()
mata:
	function m_xtgranger_p(string scalar depvarn , string scalar zn, string scalar indepvarn, string scalar residn, string scalar idtn,string scalar tousen, real scalar xb)
	{
