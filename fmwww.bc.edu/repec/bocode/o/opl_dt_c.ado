...
noi di  "First splitting variable (x1) = " "`e(x1)'"
noi di  "Second splitting variable (x2) = " "`e(x2)'"
noi di  "Third splitting variable (x3) = " "`e(x3)'"
noi di "Threshold first splitting variable c1 = " e(c1)    
noi di "Threshold second splitting variable c2 = " e(c2)
noi di "Threshold third splitting variable c3 = " e(c3)
noi di "{hline 85}"
...
local I_cpt_c=r(mean) // optimal average impact constrained at threshold c 
