...
/*
16Apr07 v1.02 allow line colours and patterns for the observations
20May08 v1.03 Allow rlabels.. to vary the web
27Oct08 v1.04 Allow missing values but need to implement a gap
23Apr09 v1.05 Move to the BSU email, do line widths
 1Sep09 v1.06 Move to Stata 11
14Jun11 v1.07 Set dp period to sort out a bug
 1Dec16 v1.08 Add a "spike" radial plot as well as axes width colour and pattern styles.
10Mar17 v1.09 Add connected graph style and LS() for marker symbols
27Mar17 v1.10 Add marker color option
 2Jan18 v1.11 Add option to delete axes labels 
 5Jul18 v1.12 Remove aspectratio(1) as some graphs are misshapen
...
institute[Centre for Trials Research, Cardiff University ]
email[mandera@cardiff.ac.uk]
