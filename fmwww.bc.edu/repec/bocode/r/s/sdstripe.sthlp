...
{p2colset 5 20 22 2}{...}
{p2col :{hi:sdstripe} {hline 2}}Create a single string variable representing the sequence {p_end}
{p2colreset}{...}

{title:Syntax}

{p 8 17 2}
{cmd:sdstripe} {it:varlist}, GENerate(newvarname) [SYMbols(string) XT XTSPellsep(string) XTDursep(string)]
...
{pstd}{cmd:sdstripe} Create a single string variable representing a
...
{phang}{cmd:. sdstripe state1-state40, gen(seqstr)}{p_end}
{phang}{cmd:. sdstripe state1-state40, gen(seqstr) symbols("FPun")}{p_end}
{phang}{cmd:. sdstripe state1-state40, gen(xtstr) xt xtsp("/") xtdur(":")}{p_end}
