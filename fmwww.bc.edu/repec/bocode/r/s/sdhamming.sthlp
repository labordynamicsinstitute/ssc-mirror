...
{p2colset 5 17 23 2}{...}
{p2col:{hi:sdhamming} {hline 2}}Calculate inter-sequence distances using Hamming distance{p_end}
{p2colreset}{...}

{title:Syntax}

{p 8 17 2}
{cmd:sdhamming} {it: varlist} {cmd:,} {it:options} [option] 
...
{pstd}{cmd:sdhamming} calculates Hamming distances between all pairs
...
{phang}{cmd:. sdhamming mon1-mon36, subsmat(scost) pwdist(dist)}{p_end}
{phang}{cmd:. matrix list dist}{p_end}

{phang}{cmd:. sdhamming mon1-mon72, subsmat(scost) pwdist(dist)}{p_end}
{phang}{cmd:. matrix list dist}{p_end}
