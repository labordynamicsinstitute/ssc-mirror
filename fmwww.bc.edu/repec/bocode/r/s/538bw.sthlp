...
{title:Title}
Scheme description: 538bw graphic schemes


{* index schemes}{...}
{title:Scheme description:  538bw graphic schemes}
...
{p 4 4 2}
The scheme {cmd:538} replicates the figure design of 538 schemes for Stata. It uses 9 colors (blue; red; green; yellow; magenta; orange; pink; turquoise; black).   
...
{p 4 4 2}
The scheme {cmd:538bw} same as below, but without background color and black/gray color shading. 

{p 4 4 2}
The schemes {cmd:538} and {cmd:538w} have a gray background tinting; The schemes {cmd:538} and {cmd:538w} use 9 colors (538b; 538r, 538g; 538y; 538m; 538o; 538p; 538t; black); The schemes {cmd:538} and {cmd:538w} also provide shaded red and blue coloring (538bs1-538bs11; 538rs1-538rs11); y-axis labels are horizontal; gridlines are lines; gridlines are drawn for the x- and y-axis; gridlines are thin; x- and y-axis are in gray; markers are all small; lines are medium; fonts of labels are small; legends are not framed; legends appear on the right hand side of the figure; keylabels of legends are medium large; legends rely on rows first; plotregions are omitted; intensity of pie- and bar figures is reduced to 50; borderlines of histograms and bar are thin; marker symbols are reordered to assure that points in scatters are less often overlapping.  


{p 4 4 2}
The nine colors are blue, red, green, yellow, magenta, orange, pink, turquoise and black. All colors are exactly the same color shade as used by 538. 
