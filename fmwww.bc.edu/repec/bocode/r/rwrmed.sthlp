...
{pstd} A continuous outcome (cesd40), a continuous mediator (ses), a binary treatment (college), nine pre-treatment covariates (of which five are categorical), three post-treatment covariates, 
no interaction between treatment and mediator, and the default analytic method for estimation: {p_end}
...
{phang} Wodtke, G. T., and X. Zhou. 2020. Effect Decomposition in the Presence of Treatment-induced Confounding: A Regression-with-Residuals Approach. {it:Epidemiology} 31: 369-375.
