*! rocmicd.ado 1.0.0 17th March 2009, R.Froud. 
*  This program reports minimally important change (MIC) thresholds for deterioration using 45 degree tangent line intersection 
*  and the smallest residual sum of sensitivity ans specificity.

capture program drop rocmicd

version 10.1

program define rocmicd, rclass
