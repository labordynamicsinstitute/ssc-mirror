...
{p 6 21 2} 
{cmdab:rely} [{cmd:if} {it:exp}] [{cmd:in} {it:range}]{cmd:,}
...
{p 4 6 4}
{cmd:rely} examines reliability of predicted risks following a {cmd:logistic}
  ...
  in those categories. {cmd:rely} can be repeated on a new sample using
