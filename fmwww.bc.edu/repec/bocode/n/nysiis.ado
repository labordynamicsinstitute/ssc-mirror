...
*NB: This comes with no warrenty intended or implied and user should check results against other codes i.e. soundex()
*N.B. Many different algorithms on the web, however many dont appear to function correctly.
								   ...
								   if (((substr(`phase0',(`i'-1),1)!="a") & 	///
									...
									| 											/// OR
									    ((substr(`phase0',(`i'+1),1)!="a") & 	///
										 ...
										 (substr(`phase0',(`i'+1),1)!="i") & 	/// 
										 (substr(`phase0',(`i'+1),1)!="o") & 	///
										 (substr(`phase0',(`i'+1),1)!="u") ) )	/// Next is not a vowel
								   ...
								   if (((substr(`phase0prev',(`i'-1),1)!="a") & 	///
									...
									| 											/// OR
									    ((substr(`phase0prev',(`i'+1),1)!="a") & 	///
										 ...
										 (substr(`phase0prev',(`i'+1),1)!="i") & 	/// 
										 (substr(`phase0prev',(`i'+1),1)!="o") & 	///
										 (substr(`phase0prev',(`i'+1),1)!="u") ) )	/// Next is not a vowel
...
* n.b. Remove the duplicates characaters after rebuilding the code
********************************************************************************
