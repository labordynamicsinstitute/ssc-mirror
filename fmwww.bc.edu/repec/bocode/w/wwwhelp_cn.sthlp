{smcl}
{* 17Nov2023}{...}
{cmd:help wwwhelp {stata "help wwwhelp": English version}}{right: }
{hline}

{title:标题}

{p2colset 5 16 18 2}{...}
{p2col:{hi:wwwhelp} {hline 2}} 在浏览器窗口显示帮助文档（HTML简易版或PDF详细版），并提供帮助文档的网页链接 {p_end}
{p2colreset}{...}
...
{pstd} Online: {helpb help}, {helpb hhelp}{p_end}
