...
{pstd}The first option works as an inmidiate command, where you provide values that define groups. Each group is stacked on top of each other until 100% is reached.{p_end}
...
{phang}
{bf:. {stata "waffle_plot 45, sctopt(msize(4))"}}{p_end}

{phang}
{bf:. {stata "waffle_plot 12 45, sctopt(msize(5) msymbol(square)) "}}{p_end}

{phang}
{bf:. {stata "waffle_plot 12 45 7, sctopt(msize(6) msymbol(square)) color0(gs10) color(blue red)"}}{p_end}

{phang}
{bf:. {stata "waffle_plot 12 45 7, sctopt(msize(6) msymbol(square) mlcolor(black)) color0(gs10) color(blue red)"}}{p_end}

{phang}
{bf:. {stata `"waffle_plot 12 45 7, sctopt(msize(6) msymbol(square) mlcolor(black)) color0(gs10) color(blue red)  legend(order(1 "Rep" 2 "dem" 3 "green" 4 "unde"))"' }}{p_end}

{phang}
{bf:. {stata `"waffle_plot 12 45 7, sctopt(msize(6) msymbol(square) mlcolor(black)) color0(gs10) color(blue red)  legend(order(1 "Rep" 2 "dem" 3 "green" 4 "unde")) flip"' }}{p_end}

{phang}
{bf:. {stata `"waffle_plot 12 45 7, sctopt(msize(6) msymbol(square) mlcolor(black)) color0(gs10) color(blue red)  legend(order(1 "Rep" 2 "dem" 3 "green" 4 "Undecided")) xnobs(12) ynobs(8) "' }}{p_end}

{phang}
{bf:. {stata `"waffle_plot .12 .45 .07, sctopt(msize(6) msymbol(square) mlcolor(black)) color0(gs10) color(blue red)  legend(order(1 "Rep" 2 "dem" 3 "green" 4 "Undecided")) xnobs(12) ynobs(8) "' }}{p_end}
...
{phang}{bf:. {stata `"waffle_plot share_*, legend(order(1 "White" 2 "Black" 3 "Other")) sct(msize(7) mlcolor(black) ) title("Population Composition")"' }}{p_end}
...
{phang}{bf:. {stata `"waffle_plot white black other, legend(order(1 "White" 2 "Black" 3 "Other")) sct(msize(7) mlcolor(black) ) total title("Population Composition")"' }}{p_end}

{pstd}
Or using option total(varname). Notice that "other" is now the "left" category. {p_end}
{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other")) sct(msize(7) mlcolor(black) ) total(total) title("Population Composition")"' }}{p_end}
...
{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other")) sct(msize(7) mlcolor(black) ) total(total) title("Population Composition") individual"' }}{p_end}
...
{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other") cols(3)) sct(msize(3) msymbol(square) mlcolor(black) ) total(total)  individual by(agegrp, compact cols(7) title("Population Composition"))"' }}{p_end}

{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other") cols(3)) xnobs(20) ynobs(5) sct(msize(3)  msymbol(square) mlcolor(black) ) total(total)  individual by(agegrp, compact cols(3) title("Population Composition"))"' }}{p_end}

{phang}{bf:. {stata `"waffle_plot white black  , legend(order(1 "White" 2 "Black" 3 "Other") cols(3)) xnobs(20) ynobs(5) sct(msize(3)  msymbol(square) mlcolor(black) ) total(total)  individual by(agegrp, compact rows(2) title("Population Composition")) flip"' }}{p_end}
...
{phang}{bf:. {stata `"xi, noomit:waffle_plot i.cand [w=pop], color(cranberry*0.7 navy*0.7 forest_green*.5) sctopt(msize(4) mlcolor(black%50))  by(inc, title("1992 President Elections") subtitle("by Family Income")) legend(order(1 "Clinton" 2 "Bush" 3 "Perot") cols(3))"'}}{p_end}
