...
{viewerjumpto "Title" "jce##title"}{...}    
{viewerjumpto "Syntax" "jce##syntax"}{...}
{viewerjumpto "Description" "jce##description"}{...}   
{viewerjumpto "Examples" "jce##examples"}{...}
{viewerjumpto "Alsosee" "jce##alsosee"}{...} 
...
{p2colset 5 18 18 2}{...}
{p2col:{hi: jce} {hline 2}}Journal of China Economics Navigation Tool{p_end}
{p2colreset}{...}
...
{pstd}1. {it:year}: Four-digit year (2022 to present){p_end}
{pstd}2. {it:issue}: Issue number (integer between 1-4){p_end}


{marker description}{...}
{title:Description}

{pstd}According to econometric research resources, reproducible economics papers - 2025 latest data and code journals (including Journal of China Economics) are featured at {browse "https://www.aistata.cn/blog/300003.html":www.aistata.cn}.

{pstd}{bf:Journal of China Economics} is a comprehensive economics academic journal founded in January 2022.{p_end}

{pstd}{cmd:jce} provides navigation functions for the {browse "https://www.jcejournal.com.cn/CN/home":Journal of China Economics}, supporting browsing of article lists and direct access to papers in HTML formats.{p_end}

{pstd}This command parses data from the journal's official website, supporting HTML viewing for all content since its inaugural issue in 2022.{p_end}
...
{pstd}View all articles in 2025 Volume 1{p_end}
{phang}{stata "jce 2025 1":. jce 2025 1}{p_end}

{pstd}View contents of 2024 Volume 2{p_end}
{phang}{stata "jce 2024 2":. jce 2024 2}{p_end}

{pstd}Display command help{p_end}
{phang}{stata "help jce":. help jce}{p_end}
...
{pstd}Must use four-digit format (e.g., 2022, 2024). Two-digit abbreviations (e.g., 22, 24) are not accepted.{p_end}

{pstd}{ul:Issue format}{p_end}
{pstd}Input integer numbers (1-4) without zero-padding:{p_end}
{pstd}   - Correct: {stata jce 2025 3}{p_end}
{pstd}   - Incorrect: {stata jce 2025 03} (03 format not supported){p_end}

{pstd}{ul:Journal scope}{p_end}
{pstd}Supports content from Volume 1 of 2022 (inaugural issue) onward{p_end}
