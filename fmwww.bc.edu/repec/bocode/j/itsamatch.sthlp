...
{synopt:{opt praisk}}specifies to fit a {helpb praisk} model; the default is a {helpb glm} model with Newey-West standard errors {p_end}
...
{p 7 14 2}Help: {helpb glm}, {helpb newey}, {helpb praisk}, {helpb itsa} (if installed), {helpb itsaperm} (if installed)
 {p_end}
