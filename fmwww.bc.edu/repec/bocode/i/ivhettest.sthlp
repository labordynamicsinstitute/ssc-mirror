...
{p}{cmd:ivhettest} is for use after {help ivregress}, {help ivreg2}, {help ivreg2h}, and {help regress}.
...
{col 0}(IV)
{p 8 12}{inp:. ivreg2 y x1 x2 x3 (y2 = z1 z2 z3)}{p_end}
...
{p 1 14}Manual:  {hi:[R] ivregress}, {hi:[R] regression diagnostics}{p_end}
{p 0 19}On-line:  help for {help ivregress}; {help ivreg2} (if installed){p_end}
