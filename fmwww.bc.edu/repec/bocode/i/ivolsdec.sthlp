...
{pstd}Factor variables are allowed in {it:instruments}, {it:covariates}, {cmdab:xnb:asis}, {cmdab:wb:asis}, and {cmdab:xib:asis}.{p_end}
...
{p 5 5}(3) Marginal effect difference (or endogeneity bias): the difference between the IV- and OLS-identified marginal effects, which usually originates from endogeneity bias.{p_end}
...
{phang}{cmd:xnbasis} specifies the basis functions of X not interacted with {cmd:wbasis}.{p_end}
...
{p 4 4}Note: Standard errors of OLS and IV estimates are directely taken from {cmd:regress} and {cmd:ivregress} commands. 
...
{marker LM2015}{...}
{phang}
Lochner, L. and Moretti, E., 2015. Estimating and Testing Models with Many Treatment Levels and Limited Instruments. {it:Review of Economics and Statistics}, 97(2), pp.387-397.{p_end}
