...
{* 24Mar2014}{...}
{* 11Feb2014}{...}
{cmd:help itsa}{right: ({browse "http://www.stata-journal.com/article.html?article=up0052":SJ16-3: st0389_2})}
{hline}
...
{helpb tsvarlist}.  {opt aweight}s are allowed; see {helpb weight}.  See
...
should be implemented whenever possible (Linden 2017b & 2017c).
...
{phang}
------. 2017a.
A comprehensive set of postestimation measures to enrich interrupted
...
{p 4 14 2}Article:  {it:Stata Journal}, volume 16, number 3: {browse "http://www.stata-journal.com/article.html?article=up0052":st0389_2},{break}
...
{p 7 14 2}Help:  {helpb newey}, {helpb prais}, {helpb actest} (if installed)
 {p_end}
