...
if `"`1'"'=="g" {
	...
	* Calculate gender gap at each percentile
	...
	pctile xfbfpc = xfbf, nq(100) 
	pctile xmbmpc = xmbm, nq(100)
	pctile xfbgpc = xfbg, nq(100) 
...
if `"`1'"'=="p" {
	...
	* Calculate gender gap at each percentile
	...
	pctile xfbfpc = xfbf, nq(100) 
	pctile xmbmpc = xmbm, nq(100)
	pctile xfbppc = xfbp, nq(100)
	pctile xmbppc = xmbp, nq(100)
...
if `"`1'"'=="i" {
	...
	* Calculate gender gap at each percentile
	...
	pctile xfbfpc = xfbf, nq(100) 
	pctile xmbmpc = xmbm, nq(100)
	pctile xfbipc = xfbi, nq(100)
	pctile xmbipc = xmbi, nq(100)
