...
{* 19oct2004}{...}
{hline}
help for {hi:gphudak}         (SSC distribution 12 March 2023)
{hline}
...
a single time series in a panel. The {it:varname} can contain a time-series operator.
...
{cmd:return list} for details. Contents of the last row of this matrix are also returned as scalars. {p_end}
