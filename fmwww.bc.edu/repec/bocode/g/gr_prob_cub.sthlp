...
{phang} As e-return object, this command returns a matrix {it:e(M)} with columns equal to the actual and the predicted probabilities of every category of {it:varname}.
