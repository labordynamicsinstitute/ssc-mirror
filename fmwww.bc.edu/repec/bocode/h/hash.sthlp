...
{p 8 17 2}
{cmd:hash}
{cmd:{varlist}} [, gen({help newvar:newhashvarname}) replace nodrop]
...
{pstd}
{cmd:hash} may only be used to hash varaibles whose
cumulative product of ranges is less than or equal to 2,147,483,647
