/*HHcte.prg*/ 	@Authors: Scott Hacker and Abdulnasser Hatemi-J@

Print " This program performs a bootstrap test for causality with endogenous lag order developed by Hacker and Hatemi-J (2010). 
...
bootsimmax = 10000;    @the maximum # of simulations for computing bootstrapped critical values. It should be a multiple of 20 @
...
intorder =0;	@Integration order. 0 zero means stationary variables, 1 means one unit root, 2 means two unit roots.@


load Z[obs,v] = dat.txt ; 		/* Your data file in txt format, obs is the number of time periods (observations), v is the number of variables*/
