*! version 1.2.5  14sep2021
program define hetprobit_nodisplay, eclass byable(onecall) ///
...
/* constant only model */
	...
	`log' display _n in gr "Fitting heteroskedastic probit model:"
	#delimit ;
	`vv'
	`log' ml model `mlmethod' hetpr_lf 
