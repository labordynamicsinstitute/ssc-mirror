...
program  heckman_fixedrho
	...
	ml model lf heckman_fixedrho_lf  (`y': `y_for_ML'=`rhs') (`seldep': `seldep' = `selind') /lnsigma `if' `in', `robust' vce(`vce') title(Heckman with a specified value of rho)
