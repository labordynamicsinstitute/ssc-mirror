{smcl}
{cmd:help vioplot} {right:Nicholas Winter}
{hline}
...
{pstd}
Violin currently does not allow for more than one variable to be plotted, and does not accept weights.
...
{phang2}{cmd:. vioplot gear head, over(foreign)}

{phang2}{cmd:. vioplot gear head, over(rep78) legend( ring(0) pos(2) cols(1)) xtitle("Categories of Repair Record")}

{phang2}{cmd:. vioplot gear head, over(rep78, m) over(foreign, total)}
