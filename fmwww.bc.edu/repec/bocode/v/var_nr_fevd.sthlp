...
{p2colset 1 16 18 2}{...}
{p2col:{bf:[VAR-NR] var_nr_fevd} {hline 2}} Calculate forecast error variance 
decomposition of SVAR
{p_end}
{p2colreset}{...}
...
specifies zero long-run restrictions; and "{it:sr}" specifies [narrative] sign 
restrictions.
...
{pstd}
{cmd:var_nr_fevd} runs function {bf:{help fevd_funct:fevd_funct()}} in Mata 
