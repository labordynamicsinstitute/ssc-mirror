...
{synopthdr}
{synoptline}
{synopt :{opt mod:el(string)}}{cmd:required}. Choice of model used for classification includes "logit", "probit", "{search rforest:rforest}", "{search boost:boost}", or "{search svmachines:svmachines}"{p_end}
...
{p 4 8 2}
{cmd:model(}{it:string}{cmd:)} choice of model used for classification. The available models are "logit", "probit", "rforest", 
"boost", and "svmachines" (the {search rforest:rforest}, {search boost:boost}, and {search svmachines:svmachines} packages must
...
{p 4 8 2}
{cmd:{it:model_options}} specifies all available options for {help probit}, {help logit}, {help rforest}, {help boost}, and {help svmachines} when the chosen model is 
...
{phang2}{bf:{stata "kfoldclass low age lwt race smoke ptl ht ui, model(rforest) k(5) fig":. kfoldclass low age lwt race smoke ptl ht ui, model(rforest) k(5) fig}}{p_end}

{pstd}
Same as above but limiting age to less than 28 {p_end}
{phang2}{bf:{stata "kfoldclass low age lwt race smoke ptl ht ui if age<28, model(rforest) k(5) fig":. kfoldclass low age lwt race smoke ptl ht ui if age<28, model(rforest) k(5) fig}}{p_end}
...
{p 4 8 2} Online: {helpb probit}, {helpb logit}, {helpb estat classification}, {helpb roccomp}, {helpb rforest} (if installed),
