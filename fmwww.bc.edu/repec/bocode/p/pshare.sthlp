...
{* 12jan2016}{...}
{hi:help pshare}{...}
{right:also see: {browse "http://ideas.repec.org/p/bss/wpaper/13.html"}}
{hline}
...
{pstd}
    ...
    total outcome (for methodological details see 
    {browse "http://ideas.repec.org/p/bss/wpaper/13.html":Jann 2015}).
...
{phang}
    Jann, B. (2015). Assessing inequality using percentile shares. University 
    of Bern Social Sciences Working Papers No. 13. Available from 
    {browse "http://ideas.repec.org/p/bss/wpaper/13.html"}.
