...
prog def  plotmatrix
version 10.1
syntax , Mat(name) [,Split(numlist) Color(string) ALLCOLORS(string) NODIAG SAVE ADDBOX(numlist) Upper Lower Distance(varname) DUnit(string) MAXTicks(integer 8) FREQ FORMATCELLS(string) BLC(string) BLW(string) *]
