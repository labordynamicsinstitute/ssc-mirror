...
federal elections of 1998, 2002, 2005, 2009, 2013, 2017, or 2021. It is important to note that German zip codes might correspond to more than one electoral district.
...
for each election year were created. The dictionaries of 2009, 2013, 2017, and 2021 were created as part of the data preparation of the German Longitudinal Election Study (GLES; www.gles.eu)
...
{p 4 8 2} {ul:2017} Dictionary parsed from Gemeindeverzeichnis (directory of municipalities) that is provided by the German Statistical Office and by the search tool provided by the German Bundestag, using Zip codes that are provided by the open data project suche-postleitzahl.org.

{p 4 8 2} {ul:2021} Dictionary parsed from Gemeindeverzeichnis (directory of municipalities) that is provided by the German Statistical Office and by the search tool provided by the German Bundestag, using Zip codes that are provided by the open data project suche-postleitzahl.org.
...
The installed version is 2.0 (18-Mar-2021). 	
	
{marker aut}
{title:Authors}

{p 4 4 2} Konstantin Glinitzer, Addendum, https://www.addendum.org/
...
{p 4 4 2} Copyright (C) 2021  Konstantin Glinitzer, Tobias Gummer, Malte Kaukal, Joss Roßmann
...
{p 4 4 2} Recommended citation (APA Style, 6th ed.): Glinitzer, K., Gummer, T., Jungmann, N., Kaukal, M., Roßmann, J. (2021): plztowknr: Stata module to translate German zip codes into electoral districts (Version: 2.0) [Computer Software]. Chestnut Hill, MA: Boston College.
