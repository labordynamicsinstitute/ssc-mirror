/*
partially_sharp_ordered_or_not.ado performs the following operation:
...
quietly capture program drop partially_sharp_ordered_or_not
quietly program partially_sharp_ordered_or_not
