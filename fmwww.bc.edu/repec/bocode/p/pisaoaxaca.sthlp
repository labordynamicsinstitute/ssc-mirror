{smcl}
{* *! version 3  DEC2013}{...}
{cmd:help pisaoaxaca} {right:also see:  {help pisastats} {help pisareg} {help pisacmd} {help pisaqreg} {help pisadeco} {help pv}}
{hline}
...
{phang2}{cmd:. pisaoaxaca scie intscie, by(gender) cnt(POL) save(example1) round(3)} {p_end}

{phang2}{cmd:. pisaoaxaca read escs gender, by(wave) cnt(AUS) save(example2) } {p_end}

{phang2}{cmd:. pisaoaxaca scieeff escs, by(gender) cnt(AUS POL GBR) save(example3) round(6)}  {p_end}
