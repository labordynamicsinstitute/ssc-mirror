...
{p 0 0}
{opt blc(colorstyle)} specifies the color for the outline of each box.

{p 0 0}
{opt blw(linewidthstyle)} specifies the thickness of the line surrounding each box, the default is vvvthin.
