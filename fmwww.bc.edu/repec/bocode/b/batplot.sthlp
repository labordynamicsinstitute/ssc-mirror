...
{synopt:{opt dp:}(#)} specifies the precision of the numbers in the title of the graph.{p_end}
...
{phang}
{opt dp:}(#) specifies the precision of the numbers in the title of the graph. The
