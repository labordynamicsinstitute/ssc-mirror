...
{p 4 8}Run a correctly specified {cmd: bunchtobit} with binwidth and saving options:{p_end}
{p 8 8}{cmd:. bunchtobit y x1 x2 x3 , k(2.0794) tax0(-0.3) tax1(0.1)  binwidth(0.08) saving(ctobitdata, replace)}{p_end}

{p 4 8}Run a misspecified {cmd: bunchtobit} with verbose, numiter, binwidth, and saving options:{p_end}
{p 8 8}{cmd:. bunchtobit y x1 x3 , k(2.0794) tax0(-0.3) tax1(0.1) verbose numiter(1000) binwidth(0.08) saving(mtobitdata, replace)}{p_end}
