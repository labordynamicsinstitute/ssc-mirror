...
{p 8 8}{cmd:. bunching yfric x1 x2 x3, k(2.0794) tax0(-0.3) tax1(0.1) m(2) gen(yfilter) deltam(0.1054) deltap(0.0953) perc_obs(30) polorder(7) savingtobit(dtobit.dta,replace) savingbounds(dbounds.dta, replace)}{p_end}

{p 4 8}Run {cmd: bunching} without filter:{p_end}
{p 8 8}{cmd:. bunching  y x1 x2 x3, k(2.0794) tax0(-0.3) tax1(0.1) m(2) savingtobit(dtobit2.dta, replace) savingbounds(dbounds2, replace)}{p_end}
