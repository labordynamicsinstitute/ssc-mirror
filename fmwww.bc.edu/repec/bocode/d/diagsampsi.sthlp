...
{synopt :{opt w:idth(#)}}specify the half width of the confidence interval (ranging from 0.01 to 1.0) that is maximally clinically acceptable; default is {cmd: width(0.10)}{p_end}
...
{p 4 8 2}
{opt w:idth(#)} specifies the half width of the confidence interval (ranging from 0.01 to 1.0) that is maximally clinically acceptable; default is {cmd: width(0.10)}.
