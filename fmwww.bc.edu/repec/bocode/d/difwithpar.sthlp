...
{p 0 4 2}
{cmd:*** Please note that as of May 2015 this can all be done within Stata by downloading -difdetect- from SSC.  PARSCALE is not needed anymore. ***}{break} 
...
{p 4 4 2}
{cmd:difdetect}, {cmd:difd}, {cmd:runparscale}, {cmd:prepar}, and {cmd:mergevirtual}.  
