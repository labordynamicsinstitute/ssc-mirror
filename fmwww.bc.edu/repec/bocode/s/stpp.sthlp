...
{phang}
{opt inccens} evaluate survival functions at censoring times as well as event times. This will lead to more precise long term estimates when there is sparse data, but will increase computation time.
