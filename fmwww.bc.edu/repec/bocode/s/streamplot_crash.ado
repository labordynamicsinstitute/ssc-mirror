...
version 15
	...
	syntax varlist(min=2 max=2 numeric) [if] [in], by(varname) [color(string) alpha(real 80) smooth(real 6)] ///
		...
		[ xticks(string) xtitle(string) ytitle(string) title(string) subtitle(string) note(string) scheme(string) ] ///
