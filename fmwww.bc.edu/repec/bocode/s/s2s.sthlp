...
{pstd} Note: the data may be downloaded into the current working folder instead of the suggested path "../t/Tanzania_dataset.dta". User can type {cmd:net get s2s} to download the data and subsequently type {cmd:pwd} to identify the current working folder.{p_end}
