{smcl}
{* *! aedots version 1.2 05March2021}{...}
{cmd:help aedots}
{hline}
...
{phang2}{cmd:. aedots ae_pt, n1(event1) n2(event2) tot1(total1) tot2(total2) logoff(1)}{p_end}
...
{phang2}{cmd:. use example_dot.dta, clear}{p_end}
{phang2}{cmd:. aedots ae_pt, n1(event1) n2(event2) tot1(total1) tot2(total2) logoff(1) rightxlabel(0.01 0.03 0.1 0.5 0 1 5 10 20 50 150)}{p_end}
...
{phang2}{cmd:. use example_dot.dta, clear}{p_end}
{phang2}{cmd:. aedots ae_pt, n1(event1) n2(event2) tot1(total1) tot2(total2) nummargin(1) margin(30) event1pos(7) event2pos(8.5) marginpos(r)}{p_end}
...
{phang2}{cmd:. use example_dot.dta, clear}{p_end}
{phang2}{cmd:. aedots ae_pt, n1(event1) n2(event2) tot1(total1) tot2(total2) nummargin(1) margin(20)  event1pos(-6.75) event2pos(-5.25) marginpos(l) event1posy(-0.5) event2posy(-0.5)}{p_end}
