...
(13) rightxline(numlist) is optional vertical line on the scatter plot that appears on the right of the plot
		- default is at 0 for log(relrisk) and risk difference(log rel risk value 0 = rel risk val=1) and
		1 for rel risk on log scale
...
if `legendleftyn' ==1 & "`legendright'"!="" &  `riskdiff'==0 & `logoff'==0 {
