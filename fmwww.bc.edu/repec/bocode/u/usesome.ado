*! version 2.0.0 13may2021 daniel klein
program usesome
    version 10.1
    ...
    [ ,                             /// 
        ...
        FINDNAME(passthru)          ///
        noReturn                    /// 
        READDTA  /// for certification; not documneted
...
program ds_findname
    /*
        ...
        we do not allow options that might be added
         to -ds- and/or -findname- after 13may2020
...
program old_syntax
    /*
        support old syntax (up to 1.2.0)
...
void parse_syntax(`usesome_info' info)
{
    ...
    if (info.fn == "") {
        /*
            modern syntax allowes -if- and -in- qualifiers
...
void get_vartag(`usesome_info' info)
{
    ...
    /*
        ...
        we have a subroutine for all 3 elements 
         soubroutines convert elements to possitions in <vartag>
...
void ds_findname(`usesome_info' info)
{
    ...
    /*
        the calls to st_ds_finename() below assure that
