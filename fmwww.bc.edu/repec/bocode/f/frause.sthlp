...
{phang}{opt dir([str])} request listing all datasets currently available in the repository. If no string is provided, it displays ALL datasets. But, if some string is provided, it displays only datasets that start with that string
