...
{p2colset 5 16 18 2}{...}
{p2col:{hi: fvstrip} {hline 2}}Stata utility for removing b/n/o factor variable operators from varlists{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:fvstrip} saves the following in {cmd:r()}:
...
{pstd}
{opt fvstrip} is a utility for removing the b/n/o factor variable operators from a varlist.
With the {cmd:expand} option, it will expand the varlist if not already expanded.

{pstd}
{opt fvstrip} is intended for use by Stata programmers,
...
{phang2}. {stata "fvstrip `r(varlist)'"}{p_end}
{pstd}Or:{p_end}
{phang2}. {stata "fvexpand i.rep78"}{p_end}
{phang2}. {stata "fvstrip `r(varlist)', dropomit"}{p_end}
...
{phang2}. {stata "fvstrip $vlist"}{p_end}

{phang2}. {stata "return list"}{p_end}

{phang2}. {stata "fvstrip i.rep78, expand noi"}{p_end}

{phang2}. {stata "fvstrip i.rep78 if rep78~=3, expand noi"}{p_end}

{phang2}. {stata "fvstrip i.rep78, expand dropomit noi"}{p_end}

{phang2}. {stata "fvexpand i.rep78#i.foreign"}{p_end}

{phang2}. {stata `"di "`r(varlist)'""'}{p_end}

{phang2}. {stata "fvstrip `r(varlist)', dropomit noi"}{p_end}

{pstd}{cmd:expand} option means an internal call to {cmd:fvexpand} so order changes:{p_end}

{phang2}. {stata "fvstrip 2.rep78 1.rep78, noi"}{p_end}

{phang2}. {stata "fvstrip 2.rep78 1.rep78, noi expand"}{p_end}

{pstd}Fails because i.foreign is unexpanded:{p_end}

{phang2}. {stata "fvstrip i.foreign 2.rep78 1.rep78, noi"}{p_end}

{pstd}Fails because of base category conflict in internal {cmd:fvexpand} call:{p_end}

{phang2}. {stata "fvstrip i.foreign 2b.rep78 1b.rep78, noi expand"}{p_end}

{pstd}Works:{p_end}

{phang2}. {stata "fvstrip i.foreign 2.rep78 1.rep78, noi expand onebyone"}{p_end}
