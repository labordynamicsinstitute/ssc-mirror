...
{p 8 18 2}
{cmd:favplot} {it:{help indepvars:predictor}} [{cmd:,} {it:favplot_options} {it:formatting_options}]
...
plot) after {cmd:regress}.  {it:predictor} may be a predictor variable
(a.k.a. explanatory variable, covariate, independent variable) that is currently in the
model or not.
...
been assigned, the variable name} for each {it:predictor} shown. Example:
