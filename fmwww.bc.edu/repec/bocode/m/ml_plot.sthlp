{smcl}
{* *! ml_plot.sthlp  metaLong for Stata 14.1}{...}
...
{hline}
{title:ml_plot — Combined Publication-Ready Longitudinal Meta-Analysis Figures}
...
{pstd}
{cmd:ml_plot} assembles a combined multi-panel figure from the results of the
...
{phang2}{cmd:. ml_plot, metafile(meta_res) sensfile(sens_res) ///}
...
To export to PDF or PNG, use {helpb graph export} after {cmd:ml_plot}.
