*! mktex.ado version 2.91
*! Convert Microsoft Word documents to complete LaTeX documents
*! Fixed display command syntax
*! 2.91: restore pandoc_cmd for MacOSX
    ...
    * Simple or full LaTeX document
    if "`simple'" != "" {
        ...
        * Write LaTeX document header
        ...
        file write `fh_out' "% Date: 31Jan2026" _n _n
            ...
            * Check if PDF was created
            ...
            if !_rc {
                ...
                * Clean up auxiliary files
                ...
                di as text "Note: PDF creation failed"
                di as text "Try manual compilation: `latex_engine' `texfile'"
                if "`simple'" == "" & "`notoc'" == "" {
