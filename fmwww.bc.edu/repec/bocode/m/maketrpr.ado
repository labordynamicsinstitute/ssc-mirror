...
qui {
  ...
  // generate a stub for the subsequent reshape
  // Note this requires that "`state'*" only describes variables in varlist
  // "keep `varlist'" above assures this
