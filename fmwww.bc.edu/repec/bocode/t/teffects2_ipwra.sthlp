...
{viewerjumpto "Syntax" "teffects2 ipwra##syntax"}{...}
{viewerjumpto "Description" "teffects2 ipwra##description"}{...}
{viewerjumpto "References" "teffects2 ipwra##references"}{...}
{viewerjumpto "Examples" "teffects2 ipwra##examples"}{...}
{viewerjumpto "Stored results" "teffects2 ipwra##results"}{...}
{viewerjumpto "Acknowledgments" "teffects2 ipwra##acknowledgments"}{...}
{viewerjumpto "License" "teffects2 ipwra##license"}{...}
{viewerjumpto "Authors" "teffects2 ipwra##authors"}{...}
{hline}
help for {hi:teffects2 ipwra}
{hline}

{title:Title}

{phang}
{bf:teffects2 ipwra} {hline 2} Inverse probability weighted regression adjustment

{marker syntax}
{title:Syntax}

{p 8 12 2}
{cmd:teffects2} {cmd:ipwra}
   {cmd:(}{it:{help varname:ovar}} {it:{help varlist:omvarlist}}{cmd:)}
   {cmd:(}{it:{help varname:tvar}} {it:{help varlist:tmvarlist}}
      [{cmd:,} {it:{help teffects2 ipwra##tmodel:tmodel}}]{cmd:)}
	{ifin} 
        [{it:{help teffects2 ipwra##weight:weight}}]
     [{cmd:,}
          {it:{help teffects2 ipwra##stat:stat}}
          {it:{help teffects2 ipwra##options_table:options}}]
...
{pstd}
{cmd:teffects2} {cmd:ipwra} estimates the average treatment effect (ATE)
and the average treatment effect on the treated (ATT) from observational
data by inverse probability weighted regression adjustment (IPWRA).  IPWRA
estimators use estimated probability weights to correct for the missing data on
the potential outcomes as well as (in this implementation) linear regression models
for potential outcome means.  IPWRA estimators have the double robustness property.
{cmd:teffects2} {cmd:ipwra} also reports an estimate of the average untreated
outcome (when estimating the ATE) or the average untreated outcome for the
treated (when estimating the ATT).  This estimate is referred to as {cmd:POmean}.

{pstd}
Unlike {cmd:teffects} {cmd:ipwra}, {cmd:teffects2} {cmd:ipwra} allows for estimation
...
IPWRA estimators always use normalized weights, which implies that, unlike
{cmd:teffects2} {cmd:ipw} and {cmd:teffects2} {cmd:aipw}, {cmd:teffects2} {cmd:ipwra}
does not offer a choice between {cmd:nrm} and {cmd:unnrm} options.

{pstd}
{cmd:teffects2} {cmd:ipwra} will determine that the overlap assumption is violated
...
Please cite this paper if you use {cmd:teffects2} {cmd:ipwra} in your work.
...
{title:Examples}
        ...
        . {stata "teffects2 ipwra (diff age educ re74 nodegree married black hispanic) (treated age educ re74 nodegree married black hispanic), atet"}

        . {stata "teffects2 ipwra (diff age educ re74 nodegree married black hispanic) (treated age educ re74 nodegree married black hispanic, logit), atet"}
        {txt}
...
{pstd}
{cmd:teffects2} {cmd:ipwra} stores the following in {cmd:e()}:
