*! 1.0.0 NJC & Joseph N. Luchman 4 March 2015 
* all subsets of 1 ... k distinct selections from a list of k items for Stata 8-9
program tuples8
	version 8
	syntax anything [, max(numlist max=1 int >0) min(numlist max=1 int >0) asis DIsplay VARlist]
