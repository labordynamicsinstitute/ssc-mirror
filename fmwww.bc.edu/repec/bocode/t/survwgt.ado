*! survwgt 1.2.2 04sep08 NJGW
*
* 1.2.1	fixed bug finding hadamard matrix file when directory has spaces
	...
	qui {
		...
		forval j=1/`nvar' {
			...
			if `reason'>=4 {
				...
				noi di "{txt}Convergence achieved after {res}`reps'{txt} iterations.
			}
