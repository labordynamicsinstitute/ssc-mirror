...
capture program drop table1_mc13
program define table1_mc13, sclass
	version 13.0 // mc change from 12
			...
			* continuous, normally distributed variable
			if "`vartype'"=="contn" {
				...
				* collapse to table1 format      (mc changed a lot of this)
				...
				qui replace _columna = "" if mean ==.
				qui replace _columnb = "" if mean ==.
			...
			* continuous, skewed variable
			if "`vartype'"=="conts" {
				...
				* collapse to table1 format          (mc changed a lot of this)
				...
				qui replace _columna = "" if p50 ==.
				qui replace _columnb = "" if p50 ==.
