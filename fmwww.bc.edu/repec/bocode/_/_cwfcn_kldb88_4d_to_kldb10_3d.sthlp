...
{hi:kldb88_4d_to_kldb10_3d()} {hline 2} Translate 4-digit KldB-1988 to 3-digit KldB-2010 codes

{title:Syntax}

        {cmd:kldb88_4d_to_kldb10_3d(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-1988 types of occupations (4 digit codes) to KldB-2010 occupational groups (3 digit codes) using {helpb crosswalk}.

{pstd}
    {cmd:kldb88_4d_to_kldb10_3d()} is implemented as a wrapper for 
