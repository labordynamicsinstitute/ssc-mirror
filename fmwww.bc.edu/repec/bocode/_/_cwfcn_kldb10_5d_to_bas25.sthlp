...
{title:Syntax}
        ...
        {cmd:kldb10_5d_to_bas25(}{varname}{cmd:)}
...
{hi:kldb10_5d_to_bas25()} {hline 2} Translate 5-digit KldB-2010 to BAS-2|5 scores.
...
{pstd}
    5-digit KldB-2010 codes could also be translated to BAS-3 occupational prestige scores via {helpb _cwfcn_kldb10_5d_to_bas3:kldb10_5d_to_bas3()}. 
    {p_end}
...
{pstd}
    ...
    {p_end}
        ...
        {cmd:kldb10_5d_to_bas25(}{varname} 2{cmd:)}.
...
{pstd}
    {cmd:kldb10_5d_to_bas25()} is implemented as a wrapper for 
