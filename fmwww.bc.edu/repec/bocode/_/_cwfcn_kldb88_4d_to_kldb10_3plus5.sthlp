...
{hi:kldb88_4d_to_kldb10_3plus5()} {hline 2} Translate 4-digit KldB-1988 to 3plus5-digit KldB-2010 codes

{title:Syntax}

        {cmd:kldb88_4d_to_kldb10_3plus5(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-1988 types of occupations (4 digit codes) to KldB-2010 occupational groups (3 digit codes) combined with the skill level (5th-digit) using {helpb crosswalk}.
