...
{hi:kldb92_4d_to_kldb10_4d()} {hline 2} Translate 4-digit KldB-1992 to 4-digit KldB-2010 codes

{title:Syntax}

        {cmd:kldb92_4d_to_kldb10_4d(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-1992 types of occupations (4 digit codes) to KldB-2010 occupational sub-groups (4 digit codes) using {helpb crosswalk}.

{pstd}
    {cmd:kldb92_4d_to_kldb10_4d()} is implemented as a wrapper for 
