...
{hi:kldb10_3plus5_to_bas25()} {hline 2} Translate 3plus5-digit KldB-2010 to 2-digit KldB-2010 codes

{title:Syntax}

        {cmd:kldb10_3plus5_to_bas25(}{varname}{cmd:)}
...
{hi:kldb10_3plus5_to_bas25()} {hline 2} Translate 3plus5-digit KldB-2010 to BAS-2|5 scores.
...
{pstd}
    ...
    3plus5-digit KldB-2010 codes could also be translated to BAS-3 occupational prestige scores via {helpb _cwfcn_kldb10_3plus5_to_bas3:kldb10_3plus5_to_bas3()}. 
...
{pstd}
    ...
    {p_end}
        ...
        {cmd:kldb10_3plus5_to_bas25(}{varname} 2{cmd:)}.
...
{pstd}
    {cmd:kldb10_3plus5_to_bas25()} is implemented as a wrapper for 
    {helpb _cwfcn_kldb10_3plus5_to_kldb10_2plus5:kldb10_3plus5_to_kldb10_2plus5()} followed by
    {helpb _cwfcn_kldb10_2plus5_to_bas25:kldb10_2plus5_to_bas25()}.
    {p_end}
    
{hline}
{asis}
.kldb10_3plus5_to_kldb10_2plus5
.kldb10_2plus5_to_bas25
