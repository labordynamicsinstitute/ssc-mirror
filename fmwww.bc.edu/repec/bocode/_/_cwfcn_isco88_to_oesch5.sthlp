...
{hi:isco88_to_oesch5()} {hline 2} Translate 4-digit ISCO-88 to 5 OESCH classes

{title:Syntax}

        {cmd:isco88_to_oesch5(}{varname} [{help crosswalk##case:{it:case}}]{cmd:)}
...
{pstd}
    Typical usage:
        ...
        {cmd:isco88_to_oesch5(}{varname} {cmd:case.oesch(}{it:sempl} {it:supvis}{cmd:)}{cmd:)}
...
{pstd}
    {helpb crosswalk} table translating 4-digit ISCO-88 codes to 5 OESCH classes
    (Oesch 2006a,b). Also see {helpb _cwfcn_isco88_to_oesch:isco88_to_oesch()} and
    {helpb _cwfcn_isco88_to_oesch8:isco88_to_oesch8()}.
