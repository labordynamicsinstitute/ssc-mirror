...
{hi:isco08_to_oesch8()} {hline 2} Translate 4-digit ISCO-08 to 8 OESCH classes

{title:Syntax}

        {cmd:isco08_to_oesch8(}{varname} [{help crosswalk##case:{it:case}}]{cmd:)}
...
{pstd}
    Typical usage:
        ...
        {cmd:isco08_to_oesch8(}{varname} {cmd:case.oesch(}{it:sempl} {it:supvis}{cmd:)}{cmd:)}
...
{pstd}
    {helpb crosswalk} table translating 4-digit ISCO-08 codes to 8 OESCH classes
    (Oesch 2006a,b). Also see {helpb _cwfcn_isco08_to_oesch:isco08_to_oesch()} and
    {helpb _cwfcn_isco08_to_oesch5:isco08_to_oesch5()}.
