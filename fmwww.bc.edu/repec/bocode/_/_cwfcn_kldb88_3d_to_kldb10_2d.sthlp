...
{hi:kldb88_3d_to_kldb10_2d()} {hline 2} Translate 3-digit KldB-1988 to 2-digit KldB-2010 codes

{title:Syntax}

        {cmd:kldb88_3d_to_kldb10_2d(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-1988 occupational orders (3 digit codes) to KldB-2010 occupational main groups (2 digit codes) using {helpb crosswalk}.

{pstd}
    {cmd:kldb88_3d_to_kldb10_2d()} is implemented as a wrapper for 
