...
capture program drop _teffects2_getstatsipwra
program define _teffects2_getstatsipwra, sclass
	version 17
	...
	if "`unnrm'"!="" {
		di as txt "{p 0 4 2}{bf:Note:} IPWRA always uses normalized weights; {bf:unnrm} has no effect.{p_end}"
	}
