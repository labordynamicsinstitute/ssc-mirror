...
{title:Syntax}
        ...
        {cmd:kldb92_4d_to_kldb10_3plus5(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-1992 types of occupations (4 digit codes) to KldB-2010 occupational groups (3 digit codes) combined with the skill level (5th-digit) using {helpb crosswalk}.
