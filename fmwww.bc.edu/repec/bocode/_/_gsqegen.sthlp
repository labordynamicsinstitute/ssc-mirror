...
{phang} {cmd:sqtostring()} [{cmd:,} {cmd:gapinclude so se} {opt
subseq:uence(range)} ] generates a string representation of the
...
{phang} {cmd:sqstrnn(varname)} [{cmd:,} {cmd:sqstrlev-options} {opt
subseq:uence(range)} ] creates a string variable holding the strings
in varname that are most similar to each entry in varname. All options
allowed for {help sqstrlev} are allowed.
