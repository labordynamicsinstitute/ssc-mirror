* actest cert script 1.0.15 CFB 29apr2024
...
webuse lutkepohl, clear
reg investment L(1/4).income
actest, lags(8)
storedresults save resreg r()
glm investment L(1/4).income, family(gaussian) link(identity)
actest, lags(8)
storedresults compare resreg r()
