* ivreg2 cert script 1.1.2 CFB 7feb2015
...
gen singleton=(_n==1)
* Should error out
capt noi ivreg2 price singleton (mpg = weight turn), rob gmm2s
rcof "ivreg2 price singleton (mpg = weight turn), rob gmm2s" == 504
