...
{pstd}{vieweralsosee "cnuse" "help cnuse"}{break}
{vieweralsosee "topsis" "help topsis"}{break}
{vieweralsosee "log2md" "help log2md"}{break}
...
{viewerjumpto "Title" "cjs##title"}{...}    
{viewerjumpto "Syntax" "cjs##syntax"}{...}
{viewerjumpto "Description" "cjs##description"}{...}   
{viewerjumpto "Examples" "cjs##examples"}{...}
{viewerjumpto "Alsosee" "cjs##alsosee"}{...} 
...
{p2colset 5 16 16 2}{...}
{p2col:{hi: cjs} {hline 2}}Chinese Journal of Sociology Navigation Tool{p_end}
{p2colreset}{...}
...
{pstd}1. {it:year}: Four-digit year (2005 to present){p_end}
{pstd}2. {it:issue}: Issue number (integer between 1-6){p_end}


{marker description}{...}
{title:Description}

{pstd}According to econometric research resources, reproducible economics papers - 2025 latest data and code journals (including Chinese Journal of Sociology) are featured at {browse "https://www.aistata.cn/blog/300003.html":www.aistata.cn}.

{pstd}{cmd:cjs} provides navigation functions for the {browse "https://www.society.shu.edu.cn/CN/1004-8804/home.shtml":Chinese Journal of Sociology}, supporting browsing of article lists and direct access to papers in HTML and PDF formats.{p_end}

{pstd}This command parses data from the journal's official website, supporting HTML viewing and PDF browsing/downloading for all content since 2005.{p_end}
...
{pstd}• Currently, it supports HTML web page urls and PDF links for all journal papers on the official website from 2005 to the present{p_end}


{marker examples}{...}
{title:Examples}

{pstd}View all articles in 2025 Volume 2{p_end}
{phang}{stata "cjs 2025 2":. cjs 2025 2}{p_end}

{pstd}View contents of 2024 Volume 6{p_end}
{phang}{stata "cjs 2024 6":. cjs 2024 6}{p_end}

{pstd}Display command help{p_end}
{phang}{stata "help cjs":. help cjs}{p_end}
...
{pstd}   - Must use four-digit format (e.g., 2005, 2023). Two-digit abbreviations (e.g., 05, 23) are not accepted.{p_end}

{pstd}{ul:Issue format}{p_end}
{pstd}Input integer numbers (1-6) without zero-padding:{p_end}
{pstd}   - Correct: {stata cjs 2024 1}{p_end}
{pstd}   - Incorrect: {stata cjs 2024 01} (01 format not supported){p_end}

{pstd}{ul:Journal scope}{p_end}
{pstd}   - Supports content from Volume 1 of 2005 onward{p_end}
{pstd}   - (Note: Chinese Journal of Sociology is a bimonthly journal with 6 issues per year){p_end}
