...
{p 8 17 2}
{cmdab:clocktomins:} var, diaryid(string) diaryst(n) 
...
{phang2}. {stata "clocktomins tustarttim, diaryid(tucaseid) diaryst(4)":clocktomins tustarttim, diaryid(tucaseid) diaryst(4)}{p_end}
{phang2}. {stata "order tucaseid tustarttim start":order tucaseid tustarttim start}{p_end}
{phang2}. {stata "browse":browse}{p_end}
