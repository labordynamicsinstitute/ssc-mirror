...
sort ye month
 ...
 file write f "*! cpigen version 1.2 by Austin Nichols <nichols@nber.org>, compiled 1 Sep 2011"
 file write f "* cpigen version 1.1 by Austin Nichols <nichols@nber.org>, compiled 30 Jan 2008"
 file write f "* add quarterly calculation, split into separate prog to avoid system limit, add tsset"
 file write f "* cpigen version 1.0 by Austin Nichols <nichols@nber.org>, compiled 30 Jan 2008"
 file write f _n "*! program to put CPI-U and related series on current data to deflate US prices"
 file write f _n "*! CPI-U monthly or annual series avail Jan 1947 to `: word `lastm' of `c(Mons)'' `last'"
...
* update http://www.bls.gov/cpi/cpiurs1978_2008.pdf
